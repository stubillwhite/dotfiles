...
function git-stats-top-team-committers-by-repo() {
    ...
    [ "${team}" = 'consumption' ]        && teamMembers="'Abhijit Patil', 'Sasikumar Periyasamy', 'Talvinder Matharu', 'Nitin Dumbre', 'Ankur Jain', 'Narasimha Reddybhumireddygari', 'Delia Bute', 'Jaroslavs Stepanenko', 'Mustafa Toplu', 'Domenico Luciano', 'Parimala Balaraju', 'Shijith Kannoth'"
...
function certificate-java-install() {
    if [[ $# -ne 1 ]] ; then
        ...
        echo
        echo 'Example:'
        echo 'certificate-java-install /Users/white1/dev/certificates/Zscaler-Root-cert-2025.cer'
